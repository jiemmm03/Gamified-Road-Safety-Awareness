...
enum class UserRole(val backendValue: String, val displayLabel: String) {
    ...
    companion object {
        /**
         * Safely parses the canonical role string. Returns null if the value is invalid/unrecognized.
         */
        fun parseRoleOrNull(raw: String?): UserRole? {
        ...
        fun fromRoleString(raw: String?): UserRole {
            return parseRoleOrNull(raw) ?: USER
        }
